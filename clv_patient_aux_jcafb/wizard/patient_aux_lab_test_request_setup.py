...
class PatientAuxLabTestRequestSetup(models.TransientModel):
    _description = 'Patient Aux Lab Test Request Setup'
    _name = 'clv.patient_aux.lab_test.request.setup'

    def _default_patient_aux_ids(self):
        return self._context.get('active_ids')
    patient_aux_ids = fields.Many2many(
        comodel_name='clv.patient_aux',
        relation='clv_patient_aux_patient_aux_lab_test_request_setup_rel',
        string='Patients (Aux)',
    ...
    lab_test_type_ids = fields.Many2many(
        ...
        relation='clv_lab_test_type_patient_aux_lab_test_request_setup_rel',
    ...
    def do_patient_aux_lab_test_request_setup(self):
        self.ensure_one()
