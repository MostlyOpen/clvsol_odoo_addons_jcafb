...
class LabTestRequestCodePoolSetUp(models.TransientModel):
    ...
    lab_test_result_code_pool_ids = fields.Many2many(
        ...
        relation='clv_lab_test_result_code_pool_item_setup_rel',
    ...
    def do_lab_test_result_code_pool_item_setup(self):
        ...
        LabTestRequestCodePoolItem = self.env['clv.lab_test.result.code_pool.item']
        ...
        for lab_test_result_code_pool in self.lab_test_result_code_pool_ids:
            ...
            while count < self.code_quantity:
                ...
                lab_test_result_code_pool_item = LabTestRequestCodePoolItem.create(values)
