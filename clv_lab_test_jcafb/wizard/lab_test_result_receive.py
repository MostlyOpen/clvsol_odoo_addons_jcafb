...
class LabTestResultReceive(models.TransientModel):
    ...
    def do_lab_test_result_receive(self):
        ...
        for lab_test_result in self.lab_test_result_ids:
            ...
            _logger.info(u'%s %s %s', '>>>>>', lab_test_result.code, lab_test_result.ref_name)

            ref_id = lab_test_result.ref_id._name + ',' + str(lab_test_result.ref_id.id)

            if (lab_test_result.phase_id.id == current_phase_id) and \
               (lab_test_result.state == 'draft'):
                ...
                # if lab_test_result.state not in ['draft', 'cancelled']:

                for lab_test_type in lab_test_result.lab_test_type_ids:
                    ...
                    values = {
                        ...
                        'phase_id': lab_test_result.phase_id.id,
