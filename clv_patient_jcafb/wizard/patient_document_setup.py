...
class PatientDocumentSetUp(models.TransientModel):
    _description = 'Patient Document Setup'
    _name = 'clv.patient.document_setup'

    def _default_patient_ids(self):
        return self._context.get('active_ids')
    patient_ids = fields.Many2many(
        comodel_name='clv.patient',
        relation='clv_patient_document_setup_rel',
        string='Patients',
    ...
    document_type_ids = fields.Many2many(
        ...
        relation='clv_patient_document_setup_document_type_rel',
