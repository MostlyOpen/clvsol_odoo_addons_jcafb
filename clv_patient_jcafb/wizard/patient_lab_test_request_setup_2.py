...
class PatientLabTestRequestSetup_2(models.TransientModel):
    _description = 'Patient Lab Test Request Setup 2'
    _name = 'clv.patient.lab_test.request.setup_2'

    def _default_patient_ids(self):
        return self._context.get('active_ids')
    patient_ids = fields.Many2many(
        comodel_name='clv.patient',
        relation='clv_patient_patient_lab_test_request_setup_2_rel',
        string='Patients',
    ...
    #     relation='clv_lab_test_type_patient_lab_test_request_setup_2_rel',
    ...
    def do_patient_lab_test_request_setup_2(self):
        self.ensure_one()
