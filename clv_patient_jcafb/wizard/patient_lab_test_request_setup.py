...
class PatientLabTestRequestSetup(models.TransientModel):
    _description = 'Patient Lab Test Request Setup'
    _name = 'clv.patient.lab_test.request.setup'

    def _default_patient_ids(self):
        return self._context.get('active_ids')
    patient_ids = fields.Many2many(
        comodel_name='clv.patient',
        relation='clv_patient_patient_lab_test_request_setup_rel',
        string='Patients',
    ...
    lab_test_type_ids = fields.Many2many(
        ...
        relation='clv_lab_test_type_patient_lab_test_request_setup_rel',
    ...
    def do_patient_lab_test_request_setup(self):
        self.ensure_one()
